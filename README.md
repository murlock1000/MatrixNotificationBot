...
The majority of the code is kept inside of the `bot-messenger` folder, which
...
To run the bot, the `bot-messenger` script in the root of the codebase is
